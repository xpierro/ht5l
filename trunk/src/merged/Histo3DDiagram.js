...
var Histo3DDiagram = function(canvasRef, direction) {
    ...
    // Direction du dessin (ligne ou colonne)
	this.dir = direction;

    // Part en court de surlignage
	this.currentSlice = null;

    // Poistion de la souris
	this.posMouseX = 0;
	this.posMouseY = 0;
	...
	if (typeof Histo3DDiagram.initialized == "undefined") {
         ...
         * @param that Diagramme en cours d'animation
         */
        ...
        /**
         * Retourne la couleur RGB en fonction d'un nom HTML
         * @param name Nom de la couleur en HTML
         */
        ...
        /**
         * Applique une coordonnées alpha à une couleur RGB
